...
@implementation CMTransactionsListViewController
...
#pragma mark - New Transaction Selector
- (void)newTransEventHandler {
    CMNewTransactionViewController* newTransController = [[CMNewTransactionViewController alloc] initWithNibName:@"CMNewTransactionViewController" bundle:nil];
    
    [self presentModalViewController:newTransController animated:YES];
